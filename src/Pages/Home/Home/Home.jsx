          ...
          <div className="w-full px-4">
            <div className="relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-white px-10 py-16 text-center dark:bg-dark-2 sm:px-12 md:px-[60px]">
              ...
              {/* <form>
                ...
                <InputBox type="number" name="number" placeholder="Mobile Number" />
                <InputBox type="address" name="address" placeholder="Address" />
                ...
                />
                <InputBox type="number" name="quantity" placeholder="Product Quantity" />
                <div className="mb-10">
                  <button
